const parseTitle = async (_string) => {
  var TRACK_SEPARATOR = ' - ';
  let artist = '', title = '', credits = [];
  let string = _string || '';
  ...
  // if (__DEV__) console.log('next string: ' +string );

  var parts = string.split( ' - ' );
  // if (__DEV__) console.log(parts);
  ...
  // if (__DEV__) console.log('output parts: ' + JSON.stringify(output) );
